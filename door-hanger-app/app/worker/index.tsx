...
const styles = StyleSheet.create({
  ...
  iconBtn: { backgroundColor: 'rgba(15,23,42,0.85)', borderRadius: 20, width: 36, height: 36, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#334155' },
  ...
  shiftBar: {
    ...
    backgroundColor: 'rgba(15,23,42,0.9)', borderRadius: 12,
  ...
  tabs: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#0F172A' },
  ...
  streetRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 11, borderBottomWidth: 1, borderBottomColor: '#0F172A' },
  streetRowDone: { backgroundColor: 'rgba(20,83,45,0.2)' },
  streetRowCurrent: { backgroundColor: 'rgba(23,37,84,0.4)' },
  ...
  tapEdit: { fontSize: 11, color: '#334155' },
  ...
  badgeTextPending: { color: '#1E293B' },

  signRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#0F172A', gap: 12 },
  signThumb: { width: 44, height: 44, borderRadius: 8 },
  signThumbEmpty: { width: 44, height: 44, borderRadius: 8, backgroundColor: '#0F172A', alignItems: 'center', justifyContent: 'center' },
  signInfo: { flex: 1 },
  signWorker: { fontSize: 13, fontWeight: '600', color: '#CBD5E1' },
  signTime: { fontSize: 11, color: '#475569', marginTop: 2 },
  signArrow: { fontSize: 20, color: '#334155' },
  ...
  fieldInput: { backgroundColor: '#0F172A', borderWidth: 1.5, borderColor: '#334155', borderRadius: 10, padding: 13, fontSize: 15, color: '#F1F5F9', marginBottom: 14 },
  fieldMulti: { minHeight: 64, textAlignVertical: 'top' },
  modalBtns: { flexDirection: 'row', gap: 10, marginTop: 4 },
  cancelBtn: { flex: 1, borderWidth: 1.5, borderColor: '#334155', borderRadius: 12, padding: 14, alignItems: 'center' },
  ...
  photoBox: { height: 160, borderRadius: 12, overflow: 'hidden', marginBottom: 10, borderWidth: 1.5, borderColor: '#334155' },
  photoPreview: { width: '100%', height: '100%' },
  photoPlaceholder: { flex: 1, backgroundColor: '#0F172A', alignItems: 'center', justifyContent: 'center', gap: 8 },
  ...
  signNoPhoto: { height: 80, backgroundColor: '#0F172A', borderRadius: 12, alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
  signNoPhotoText: { color: '#334155', fontSize: 13 },
});
